...
# Cross-sectional momentum on Nifty-500 — Report
*Rank the universe on trailing return, rebalance monthly, validate walk-forward with transaction costs. · {{ run_id }} · {{ data_version }} · {{ generated }}*
