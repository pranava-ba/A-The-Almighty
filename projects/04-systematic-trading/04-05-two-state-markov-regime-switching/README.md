# 04-05 · Two-state Markov regime-switching risk monitor

Estimate a Hamilton regime-switching model on index returns (calm vs crisis volatility) and drive a risk-on/off overlay off the smoothed crisis-regime probability; validate against out-of-sample stress episodes.

> Subproject **04-05** of section [04 · Systematic Trading Strategies](..). Part of the
