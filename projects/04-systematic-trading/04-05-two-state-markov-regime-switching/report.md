...
# Two-state Markov regime-switching risk monitor — Report
*Estimate a Hamilton regime-switching model on index returns (calm vs crisis volatility) and drive a risk-on/off overlay off the smoothed crisis-regime probability; validate against out-of-sample stress episodes. · {{ run_id }} · {{ data_version }} · {{ generated }}*
