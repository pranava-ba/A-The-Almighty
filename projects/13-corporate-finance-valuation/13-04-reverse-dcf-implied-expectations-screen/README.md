# 13-04 · Reverse-DCF implied-expectations screen

Invert the DCF to solve for the growth/margin the current price implies, and rank an NSE sector to flag rich vs cheap embedded expectations.

> Subproject **13-04** of section [13 · Corporate Finance & Valuation (IB/PE)](..). Part of the
