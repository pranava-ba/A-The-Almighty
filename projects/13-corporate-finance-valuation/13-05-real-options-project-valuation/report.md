...
# Real-options project valuation — Report
*Value a capex/expansion option with a binomial/BSM real-options model over Monte-Carlo scenario trees, with Sobol sensitivity on the key value drivers. · {{ run_id }} · {{ data_version }} · {{ generated }}*
