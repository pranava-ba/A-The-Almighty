...
# Order-book imbalance & micro-price signal — Report
*From the depth feed, build OBI/micro-price features to predict short-horizon returns. · {{ run_id }} · {{ data_version }} · {{ generated }}*
