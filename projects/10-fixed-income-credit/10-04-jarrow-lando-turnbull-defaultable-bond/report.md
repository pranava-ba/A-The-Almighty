...
# Jarrow-Lando-Turnbull defaultable-bond engine (Indian credit) — Report
*Reconstruct JLT from first principles: estimate a real-world rating-transition matrix from CRISIL/ICRA migration data, build the risk-neutral TPM Q̃=I+Π[Q−I], and price defaultable bonds, credit spreads and puts-on-risky-bonds; construct the exact rate-vs-credit hedge and verify monotonicity across rating grades. · {{ run_id }} · {{ data_version }} · {{ generated }}*
