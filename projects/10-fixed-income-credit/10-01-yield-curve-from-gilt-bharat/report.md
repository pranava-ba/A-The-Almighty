...
# Yield curve from GILT/Bharat-Bond ETFs — Report
*Fit a Nelson-Siegel curve from GILT/Bharat-Bond ETF prices + public RBI/CCIL yields. · {{ run_id }} · {{ data_version }} · {{ generated }}*
