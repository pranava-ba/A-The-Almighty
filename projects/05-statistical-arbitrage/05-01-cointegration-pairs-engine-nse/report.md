...
# Cointegration pairs engine (NSE) — Report
*ADF/Engle-Granger screen across a sector; Z-score state machine with borrow costs and slippage; per-pair & portfolio reporting. · {{ run_id }} · {{ data_version }} · {{ generated }}*
