# 05-01 · Cointegration pairs engine (NSE)

ADF/Engle-Granger screen across a sector; Z-score state machine with borrow costs and slippage; per-pair & portfolio reporting.

> Subproject **05-01** of section [05 · Statistical Arbitrage & Relative Value](..). Part of the
