...
# Kalman dynamic hedge-ratio pairs — Report
*Estimate a time-varying hedge ratio with a Kalman filter (state-space cointegration) and compare stability and P&L against a static-OLS hedge ratio. · {{ run_id }} · {{ data_version }} · {{ generated }}*
