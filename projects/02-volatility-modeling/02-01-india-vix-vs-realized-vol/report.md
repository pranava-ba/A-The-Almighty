...
# India VIX vs realized-vol premium — Report
*Compute Parkinson/Yang-Zhang realized vol from candles vs the India VIX level; trade the implied-realized premium. · {{ run_id }} · {{ data_version }} · {{ generated }}*
