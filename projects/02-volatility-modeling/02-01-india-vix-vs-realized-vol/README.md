# 02-01 · India VIX vs realized-vol premium

Compute Parkinson/Yang-Zhang realized vol from candles vs the India VIX level; trade the implied-realized premium.

> Subproject **02-01** of section [02 · Volatility Modeling & Trading](..). Part of the
