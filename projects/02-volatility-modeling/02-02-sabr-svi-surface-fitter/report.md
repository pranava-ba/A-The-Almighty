...
# SABR / SVI surface fitter — Report
*Fit SABR and SVI to the NIFTY chain; classify low/high-vol regimes by VIX bands and study surface dynamics. · {{ run_id }} · {{ data_version }} · {{ generated }}*
