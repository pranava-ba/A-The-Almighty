...
# Neural-network vol-surface calibration — Report
*Deep-calibrate the NIFTY IV surface with a small neural network (Horvath-style deep-learning surrogate) and benchmark speed/accuracy against SABR/SVI least-squares fits. · {{ run_id }} · {{ data_version }} · {{ generated }}*
