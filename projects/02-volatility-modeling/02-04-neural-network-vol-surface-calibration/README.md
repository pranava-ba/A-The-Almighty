# 02-04 · Neural-network vol-surface calibration

Deep-calibrate the NIFTY IV surface with a small neural network (Horvath-style deep-learning surrogate) and benchmark speed/accuracy against SABR/SVI least-squares fits.

> Subproject **02-04** of section [02 · Volatility Modeling & Trading](..). Part of the
