# 02-03 · Rough-vol Hurst estimator

Estimate the Hurst exponent on intraday NIFTY to test roughness across regimes; compare to rough-Bergomi simulation.

> Subproject **02-03** of section [02 · Volatility Modeling & Trading](..). Part of the
