...
# Rough-vol Hurst estimator — Report
*Estimate the Hurst exponent on intraday NIFTY to test roughness across regimes; compare to rough-Bergomi simulation. · {{ run_id }} · {{ data_version }} · {{ generated }}*
