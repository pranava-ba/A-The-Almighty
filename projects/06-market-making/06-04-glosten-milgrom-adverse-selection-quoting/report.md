...
# Glosten-Milgrom adverse-selection quoting — Report
*Set bid/ask from a sequential-trade information model; back out the information-driven spread component and compare it to realised adverse selection measured on the recorded depth feed. · {{ run_id }} · {{ data_version }} · {{ generated }}*
