...
# Avellaneda-Stoikov MM simulator — Report
*Quote around the micro-price with inventory skew; backtest fills against the recorded depth feed. · {{ run_id }} · {{ data_version }} · {{ generated }}*
