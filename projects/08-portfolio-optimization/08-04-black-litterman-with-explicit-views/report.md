...
# Black-Litterman with explicit views — Report
*Combine market-implied equilibrium returns with a few explicit views and their confidences; compare allocations and out-of-sample stability against plain MVO. · {{ run_id }} · {{ data_version }} · {{ generated }}*
