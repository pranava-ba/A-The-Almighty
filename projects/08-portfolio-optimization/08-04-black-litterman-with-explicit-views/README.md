# 08-04 · Black-Litterman with explicit views

Combine market-implied equilibrium returns with a few explicit views and their confidences; compare allocations and out-of-sample stability against plain MVO.

> Subproject **08-04** of section [08 · Portfolio Construction & Optimization](..). Part of the
