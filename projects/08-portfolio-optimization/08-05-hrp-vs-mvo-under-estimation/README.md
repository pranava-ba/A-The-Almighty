# 08-05 · HRP vs MVO under estimation error

Hierarchical Risk Parity vs MVO on an NSE universe, stressing the covariance with random-matrix-theory eigenvalue clipping; compare turnover and out-of-sample risk.

> Subproject **08-05** of section [08 · Portfolio Construction & Optimization](..). Part of the
