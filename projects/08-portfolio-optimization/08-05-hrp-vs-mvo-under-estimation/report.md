...
# HRP vs MVO under estimation error — Report
*Hierarchical Risk Parity vs MVO on an NSE universe, stressing the covariance with random-matrix-theory eigenvalue clipping; compare turnover and out-of-sample risk. · {{ run_id }} · {{ data_version }} · {{ generated }}*
