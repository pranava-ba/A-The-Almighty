...
# Nifty-50 MVO with shrinkage + constraints — Report
*cvxpy MVO with Ledoit-Wolf shrinkage, sector caps and no-short; trace the efficient frontier. · {{ run_id }} · {{ data_version }} · {{ generated }}*
