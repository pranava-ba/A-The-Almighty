...
# Mean-CVaR tail optimizer — Report
*Optimize mean-CVaR via the Rockafellar-Uryasev LP and compare tail behaviour and drawdowns against mean-variance. · {{ run_id }} · {{ data_version }} · {{ generated }}*
