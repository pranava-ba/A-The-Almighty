# 08-06 · Mean-CVaR tail optimizer

Optimize mean-CVaR via the Rockafellar-Uryasev LP and compare tail behaviour and drawdowns against mean-variance.

> Subproject **08-06** of section [08 · Portfolio Construction & Optimization](..). Part of the
