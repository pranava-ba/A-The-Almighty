...
# Fama-MacBeth priced-factor test — Report
*Estimate cross-sectional factor risk premia with Fama-MacBeth and Newey-West standard errors on the NSE cross-section; test which factors are actually priced. · {{ run_id }} · {{ data_version }} · {{ generated }}*
