# 09-04 · Fama-MacBeth priced-factor test

Estimate cross-sectional factor risk premia with Fama-MacBeth and Newey-West standard errors on the NSE cross-section; test which factors are actually priced.

> Subproject **09-04** of section [09 · Factor / Alpha Research](..). Part of the
