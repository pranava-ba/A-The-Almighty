...
# Multi-factor library on NSE — Report
*Value/momentum/low-vol/quality factors with IC/RankIC evaluation and cross-sectional neutralization. · {{ run_id }} · {{ data_version }} · {{ generated }}*
