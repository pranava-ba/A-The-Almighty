...
# LOB simulator seeded by Upstox depth — Report
*Replay recorded depth + inject synthetic agents to test strategy fills under realistic microstructure. · {{ run_id }} · {{ data_version }} · {{ generated }}*
