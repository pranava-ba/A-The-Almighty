...
# Heterogeneous-agent market — Report
*Momentum / value / noise traders with non-linear utilities; study wealth evolution and stylized facts. · {{ run_id }} · {{ data_version }} · {{ generated }}*
