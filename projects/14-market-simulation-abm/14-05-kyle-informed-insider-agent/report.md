...
# Kyle-informed insider agent — Report
*Add a strategic informed trader (Kyle-style) to the LOB simulator and study how price discovery and market-maker losses scale with information asymmetry. · {{ run_id }} · {{ data_version }} · {{ generated }}*
