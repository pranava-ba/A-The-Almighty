# 12-04 · Point-in-time universe & corporate-action engine

Build survivorship-bias-free, point-in-time index membership plus a split/bonus/dividend adjustment layer so every backtest sees only what was knowable at the time.

> Subproject **12-04** of section [12 · Asset Classes & Data Infrastructure](..). Part of the
