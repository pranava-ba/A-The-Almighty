...
# Point-in-time universe & corporate-action engine — Report
*Build survivorship-bias-free, point-in-time index membership plus a split/bonus/dividend adjustment layer so every backtest sees only what was knowable at the time. · {{ run_id }} · {{ data_version }} · {{ generated }}*
