...
# Cross-source reconciliation & gap-fill — Report
*reconcile() candles across Upstox / NSE / yfinance to flag bad prints and fill gaps, emitting a per-instrument data-quality scorecard. · {{ run_id }} · {{ data_version }} · {{ generated }}*
