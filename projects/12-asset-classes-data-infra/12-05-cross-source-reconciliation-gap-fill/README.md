# 12-05 · Cross-source reconciliation & gap-fill

reconcile() candles across Upstox / NSE / yfinance to flag bad prints and fill gaps, emitting a per-instrument data-quality scorecard.

> Subproject **12-05** of section [12 · Asset Classes & Data Infrastructure](..). Part of the
