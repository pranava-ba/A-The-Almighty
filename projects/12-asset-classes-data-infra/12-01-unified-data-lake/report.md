...
# Unified data lake — Report
*Ingest instruments + candles across NSE_EQ/NSE_FO/MCX_FO/NSE_CD/BSE_EQ into Parquet/DuckDB with incremental updates. · {{ run_id }} · {{ data_version }} · {{ generated }}*
