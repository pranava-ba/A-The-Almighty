...
# Finite-difference BS-PDE pricer + variance reduction — Report
*Price European and barrier options with explicit & implicit finite-difference BS-PDE solvers and a Monte-Carlo engine using antithetic / control-variate / importance sampling; study stability, convergence, and pricing error vs the Upstox chain. · {{ run_id }} · {{ data_version }} · {{ generated }}*
