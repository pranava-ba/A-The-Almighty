# 01-03 · Structured-payoff Monte Carlo pricer

Price knock-in/knock-out (SharkFin-style) payoffs on NIFTY via Monte Carlo, calibrated to the chain-implied surface.

> Subproject **01-03** of section [01 · Derivatives & Options Pricing](..). Part of the
