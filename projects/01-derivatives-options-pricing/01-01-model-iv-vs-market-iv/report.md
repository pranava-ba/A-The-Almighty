...
*Pull the NIFTY/BANKNIFTY option chain, compute BSM / CRR / trinomial prices and invert for IV, then diff against Upstox chain IV and greeks. · {{ run_id }} · {{ data_version }} · {{ generated }}*
