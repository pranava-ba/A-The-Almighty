...
# American vs European premium — Report
*LSMC (Longstaff-Schwartz) pricer on stock options; quantify the early-exercise premium vs a European CRR baseline. · {{ run_id }} · {{ data_version }} · {{ generated }}*
