...
# Risk-neutral valuation from first principles — Report
*Reproduce risk-neutral pricing binomial→continuous (replication, martingale measure, Girsanov, Feynman-Kac ↔ heat equation) and price barrier / path-dependent NIFTY claims, reconciling tree, PDE and MC — a derive-don't-cite reference implementation. · {{ run_id }} · {{ data_version }} · {{ generated }}*
