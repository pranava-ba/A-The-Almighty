...
# EVT tail-risk engine — Report
*Peaks-over-threshold GPD fits for VaR/ES in the tail; compare against historical and Gaussian VaR and backtest Expected Shortfall with the Acerbi-Szekely test. · {{ run_id }} · {{ data_version }} · {{ generated }}*
