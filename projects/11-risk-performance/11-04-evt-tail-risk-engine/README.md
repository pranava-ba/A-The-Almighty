# 11-04 · EVT tail-risk engine

Peaks-over-threshold GPD fits for VaR/ES in the tail; compare against historical and Gaussian VaR and backtest Expected Shortfall with the Acerbi-Szekely test.

> Subproject **11-04** of section [11 · Risk Management & Performance Metrics](..). Part of the
