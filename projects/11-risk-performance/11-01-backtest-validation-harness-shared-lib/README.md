# 11-01 · Backtest / validation harness (shared lib)

Walk-forward, purged CV, Deflated Sharpe and bootstrap CIs — importable by all strategy sections.

> Subproject **11-01** of section [11 · Risk Management & Performance Metrics](..). Part of the
