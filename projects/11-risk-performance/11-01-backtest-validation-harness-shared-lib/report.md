...
# Backtest / validation harness (shared lib) — Report
*Walk-forward, purged CV, Deflated Sharpe and bootstrap CIs — importable by all strategy sections. · {{ run_id }} · {{ data_version }} · {{ generated }}*
