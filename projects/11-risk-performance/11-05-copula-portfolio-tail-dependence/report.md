...
# Copula portfolio tail-dependence — Report
*Fit t and Clayton copulas to capture joint tail moves across an NSE book and stress joint drawdowns against a Gaussian-correlation baseline. · {{ run_id }} · {{ data_version }} · {{ generated }}*
