...
# Generative scenarios for risk (GAN / diffusion) — Report
*Train a GAN/diffusion model on index-return histories to generate synthetic stress scenarios for VaR/ES and portfolio stress-testing (11), validated against historical crises. · {{ run_id }} · {{ data_version }} · {{ generated }}*
