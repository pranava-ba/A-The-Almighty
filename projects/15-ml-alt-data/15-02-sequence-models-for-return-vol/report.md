...
# Sequence models for return/vol forecasting — Report
*LSTM / Transformer on candles with walk-forward evaluation; export signals downstream. · {{ run_id }} · {{ data_version }} · {{ generated }}*
