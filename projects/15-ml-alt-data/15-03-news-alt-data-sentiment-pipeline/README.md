# 15-03 · News / alt-data sentiment pipeline

FinBERT sentiment on news feeds → sentiment factor consumed by Factor/Alpha (09).

> Subproject **15-03** of section [15 · Machine Learning & Alternative Data](..). Part of the
