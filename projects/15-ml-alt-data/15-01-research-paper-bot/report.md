...
# Research-paper bot — Report
*Fetch arXiv q-fin (and SSRN) papers per section, dedup, tag, and emit a weekly digest — productionizes common/paper_fetcher.py. · {{ run_id }} · {{ data_version }} · {{ generated }}*
