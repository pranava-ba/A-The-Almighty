# 15-01 · Research-paper bot

Fetch arXiv q-fin (and SSRN) papers per section, dedup, tag, and emit a weekly digest — productionizes common/paper_fetcher.py.

> Subproject **15-01** of section [15 · Machine Learning & Alternative Data](..). Part of the
