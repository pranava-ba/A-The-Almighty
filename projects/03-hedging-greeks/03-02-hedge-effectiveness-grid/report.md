...
# Hedge-effectiveness grid — Report
*Evaluate delta-hedge slippage across moneyness (0.7-1.3) and maturities using the option chain. · {{ run_id }} · {{ data_version }} · {{ generated }}*
