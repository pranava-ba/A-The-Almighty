...
# Deep hedging vs delta hedging (RL) — Report
*Train an RL / deep-hedging agent to hedge a NIFTY option under transaction costs and discrete rebalancing; compare the terminal-P&L distribution and CVaR against Black-Scholes delta hedging. · {{ run_id }} · {{ data_version }} · {{ generated }}*
