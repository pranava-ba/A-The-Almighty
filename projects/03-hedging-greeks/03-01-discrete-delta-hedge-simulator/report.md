...
# Discrete delta-hedge simulator — Report
*Hedge a NIFTY option daily/intraday using chain greeks; decompose realized P&L into volatility-mispricing vs gamma components. · {{ run_id }} · {{ data_version }} · {{ generated }}*
